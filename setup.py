...
setup(
    ...
    packages=["withings_sync", "withings_sync/python_garminconnect"],
    ...
    install_requires=["lxml", "requests", "cloudscraper","pytimedinput","readchar", "pwinput", "garminconnect", "imap_tools"],
    entry_points={
