...
from withings_sync.python_garminconnect.example import *
...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="EMAIL_LOGIN",
        help="Login/email/username to your email to check for Garmin MFA code",
    )
    parser.add_argument(
        "--email-password",
        "--ep",
        ...
        help="Password to your email to check for Garmin MFA code",
    )
    parser.add_argument(
        "--email-server",
        "--es",
        ...
        type=str,
        metavar="EMAIL_SERVER",
        help="Email Server to check for Garmin MFA code (Should be IMAP server)",
    )
    # MFA
...
def sync():
    ...
    if not ARGS.no_upload:
        ...
        if ARGS.garmin_username and (fit_data_weight is not None or fit_data_blood_pressure is not None):
            logging.info("attempting to upload fit file...")
            if ARGS.garmin_mfa:
