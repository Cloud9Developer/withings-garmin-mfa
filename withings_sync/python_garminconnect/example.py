...
import pwinput
import readchar
sys.path.insert(1, '/src/withings_sync/python_garminconnect')
from garminconn import (
    Garmin,
    ...
    if api:
        try:
            ...
            # ACTIVITIES
                ...
                # Upload activity from file (THIS IS WHAT I NEED)
...
def uploadWithingsData(garmin_username, garmin_password, email_server, email_email, email_password, activityfile):
    # do stuff
    # Display header and login
    print("\n*** Garmin Connect API Demo by cyberjunky ***\n")
    
    # set ENV for email_email, email_password, email_server
    os.environ["EMAIL_EMAIL"] = email_email
    ...
    os.environ["EMAIL_PASSWORD"] = "REMOVED"
    os.environ["EMAIL_SERVER"] = "REMOVED"